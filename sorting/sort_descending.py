...
This function accepts a list of words and returns the list of words sorted in descending order.
Hint: elements.sort(key=None, reverse=True)
"""
def sort_words(words: List[str]) -> List[str]:
    words.sort(key = None, reverse = True)
    # print("Sort Descending words list: ", words)
    return words

"""
sort_numbers(numbers: List[int]) -> List[int] -
This function accepts a list of numbers and returns the list of numbers sorted in descending order.
"""
def sort_numbers(numbers: List[int]) -> List[int]:
    numbers.sort(key = None, reverse = True)
    # print("Sort descending numbers: ", numbers)
    return numbers

"""
sort_decimals(numbers: List[float]) -> List[float] -
This function accepts a list of decimal numbers and returns the list of decimal numbers sorted in descending order.
"""
def sort_decimals(numbers: List[float]) -> List[float]:
    numbers.sort(key= None, reverse = True)
    print("Sort descending decimals: ", numbers)
    return numbers
